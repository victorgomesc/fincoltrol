...
export function Header() {
  return (
    <header className="w-full px-6 py-3 backdrop-blur-md bg-background/80 flex items-center justify-between">
      {/* Barra de busca */}
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Futuramente: dropdown de perfil com logout/configurações */}
      </div>
    </header>
  );
}